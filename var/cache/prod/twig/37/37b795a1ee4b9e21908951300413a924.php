...
class __TwigTemplate_16b722e69d8470121da4831386d24220 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p>
      ...
      ";
        // line 30
        echo $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Discover the best-selling modules of this category in the %link% page.", ["%link%" => (((((("<a href=\"" . $this->extensions['PrestaShopBundle\Twig\LayoutExtension']->getAdminLink("AdminPsMboModule", true)) . "&filterCategoryTab=") . twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "refMenu", [], "any", false, false, false, 30)) . "\">") . twig_get_attribute($this->env, $this->source, ($context["category"] ?? null), "name", [], "any", false, false, false, 30)) . "</a>")], "Admin.Modules.Feature");
        echo "
    </p>
  </div>
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_manage_empty.html.twig", "/home/www/public/modules/ps_mbo/views/PrestaShop/Admin/Module/Includes/grid_manage_empty.html.twig");
    }
}
