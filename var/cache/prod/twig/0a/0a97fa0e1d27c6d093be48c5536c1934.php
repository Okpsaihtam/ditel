...
class __TwigTemplate_7f74a9f3e9a4ef89133deeaff2d909ff extends Template
{
    private $source;
    private $macros = [];
...
array_key_exists("origin", $context)) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none"))]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_configure.html.twig", "/home/www/public/src/PrestaShopBundle/Resources/views/Admin/Module/Includes/grid_notification_configure.html.twig");
    }
}
