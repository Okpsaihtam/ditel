...
function upgrade_module_1_4_10($module)
{
    ...
    Configuration::updateValue('elementor_page_title_selector', 'header.page-header h1');
    Configuration::updateValue('elementor_page_wrapper_selector', '#wrapper, #wrapper .container, #content');
