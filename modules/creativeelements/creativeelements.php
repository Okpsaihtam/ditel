    ...
    public function hookDisplayHeader()
    {
        ...
        if (self::getPreviewUId()) {
            if ('widget' === Tools::getValue('render') && Tools::getIsset('actions')) {
                ...
                $response = $plugin->widgets_manager->ajaxRenderWidget();
        ...
        if (isset($pages[$front]) && !empty($themes[$pages[$front]])) {
            ...
            if ('product' === $page_type) {
                $this->context->smarty->assign([
                    ...
                    'CE_PRODUCT' => $this->renderTheme($uid_theme),
                ]);
            } else {
                $desc = ['description' => $this->renderTheme($uid_theme)];
