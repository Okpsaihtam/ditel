...
class WidgetProductImages extends WidgetBase
{
    ...
    protected function _registerControls()
    {
        ...
        $this->addResponsiveControl(
            ...
            [
                ...
                'options' => ['' => __('Default')] + $slides_per_view,
                'frontend_available' => true,
                'conditions' => [
                    'relation' => 'or',
                    'terms' => [
    ...
    protected function render()
    {
        ...
        $slideshow = 'slideshow' === $settings['skin'];
        ?>
        <div class="elementor-swiper">
            <div class="elementor-main-swiper swiper-container">
                ...
                <?php foreach ($product['images'] as $i => $image) : ?>
                    <div class="swiper-slide">
                        <a href="<?= esc_attr(Helper::getProductImageLink($image)) ?>" data-elementor-lightbox-slideshow="<?= $id ?>" data-elementor-lightbox-index="<?= (int) $i ?>">
                            <img class="elementor-carousel-image" src="<?= esc_attr($image['bySize'][$image_size]['url']) ?>" alt="<?= esc_attr($image['legend']) ?>" itemprop="image">
                        <?php if ($settings['overlay']) : ?>
                            <div class="elementor-carousel-image-overlay e-overlay-animation-<?= esc_attr($settings['overlay_animation']) ?>">
            ...
            <?php if ($settings['show_arrows']) : ?>
                <div class="elementor-swiper-button elementor-swiper-button-prev">
                    ...
                    <span class="elementor-screen-only"><?= __('Previous') ?></span>
                </div>
                <div class="elementor-swiper-button elementor-swiper-button-next">
                    <i class="ceicon-chevron-right" aria-hidden="true"></i>
                    <span class="elementor-screen-only"><?= __('Next') ?></span>
                </div>
            <?php endif ?>
            </div>
        </div>
            ...
            <div class="elementor-swiper">
                <div class="elementor-thumbnails-swiper swiper-container">
                    ...
                    <?php foreach ($product['images'] as $i => $image) : ?>
                        <div class="swiper-slide">
                            <a href="<?= esc_attr(Helper::getProductImageLink($image)) ?>" data-elementor-lightbox-slideshow="<?= $id ?>" data-elementor-lightbox-index="<?= (int) $i ?>">
                                <img class="elementor-carousel-image" src="<?= esc_attr($image['bySize'][$thumb_size]['url']) ?>" alt="<?= esc_attr($image['legend']) ?>" itemprop="image">
                            </a>
                        </div>
                    <?php endforeach ?>
                    </div>
