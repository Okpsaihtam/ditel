...
class WidgetProductAddToCart extends WidgetButton
{
    ...
    {
        return ['shop', 'store', 'product', 'button', 'add to cart'];
    }
    ...
    protected function _registerControls()
    {
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} a.elementor-button:not([onclick])' => 'cursor: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} a.elementor-button:not([onclick]):not(#e)' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} a.elementor-button:not([onclick])' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} a.elementor-button:not([onclick])' => 'border-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render()
    {
        ...
        } elseif (!empty($product['add_to_cart_url'])) {
            $action = \Tools::toCamelCase($button_type, true);
            $this->addRenderAttribute('button', 'onclick', "ce$action()");
        }
        $this->setSettings('link', $link);
