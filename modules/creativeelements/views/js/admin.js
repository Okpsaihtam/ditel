...
window.ceAdmin && document.addEventListener('DOMContentLoaded', function() {
	...
	$([
		...
		'table.supplier',
		'table.cms',
		'table#product_grid_table',
		'table#category_grid_table',
		'table#manufacturer_grid_table',
		'table#supplier_grid_table',
		'table#cms_page_grid_table td.column-id_cms'
	].join(' td:nth-of-type(2),')).get().forEach(function (td) {
