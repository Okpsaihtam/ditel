...
class Frontend extends App
{
    ...
    public function registerScripts()
    {
        ...
        \Configuration::get('elementor_global_image_lightbox') && wp_register_script(
            'swiper',
        ...
        \Configuration::get('elementor_load_slick') && wp_register_script(
            'jquery-slick',
    ...
    public function registerStyles()
    {
        ...
        \Configuration::get('elementor_load_fontawesome') && wp_register_style(
            'font-awesome',
