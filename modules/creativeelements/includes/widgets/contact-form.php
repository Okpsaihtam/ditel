...
class WidgetContactForm extends WidgetBase
{
    ...
    protected function _registerControls()
    {
        ...
        $this->addControl(
            'show_reference',
            [
                'label' => $this->trans('Order Reference'),
        ...
        $this->addControl(
            ...
            [
                ...
                'placeholder' => $this->trans('Subject Heading', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'show_labels' => 'yes',
                ],
            ]
        ...
        $this->addControl(
            ...
            [
                'label' => __('Label'),
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('Email address', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'show_labels!' => '',
                ],
            ]
        ...
        $this->addControl(
            ...
            [
                'label' => __('Label'),
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('Order Reference', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'show_labels' => 'yes',
                ],
            ]
        ...
        $this->addControl(
            ...
            [
                'label' => __('Label'),
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('Attach File', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'show_labels' => 'yes',
                ],
            ]
        ...
        $this->addControl(
            ...
            [
                'label' => __('Label'),
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('Message', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'show_labels!' => '',
                ],
            ]
        ...
        $this->addControl(
            ...
            [
                'label' => __('Text'),
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('Send', [], 'Modules.Contactform.Shop', $this->locale_fo),
            ]
        );
        ...
        $this->addControl(
            ...
            [
                ...
                'label_block' => true,
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('Your message has been successfully sent to our team.', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'custom_messages!' => '',
                ],
            ]
        ...
        $this->addControl(
            ...
            [
                ...
                'label_block' => true,
                'type' => ControlsManager::TEXT,
                'placeholder' => $this->trans('An error occurred while sending the message.', [], 'Modules.Contactform.Shop', $this->locale_fo),
                'condition' => [
                    'custom_messages!' => '',
                ],
            ]
    ...
    protected function render()
    {
        ...
        <form class="elementor-contact-form" <?= $this->getRenderAttributeString('form') ?>>
            ...
            <?php else : ?>
                ...
                <?php if ($show_labels) : ?>
                    <label class="elementor-field-label" for="id-contact-<?= $id ?>">
                        <?= $settings['subject_label'] ?: $this->trans('Subject Heading') ?>
                    </label>
                <?php endif ?>
            ...
            <?php endif ?>
                ...
                <?php if ($show_labels) : ?>
                    <label class="elementor-field-label" for="from-<?= $id ?>">
                        <?= $settings['email_label'] ?: $this->trans('Email address') ?>
                    </label>
                <?php endif ?>
            ...
            <?php if ($settings['show_reference'] && (Plugin::$instance->editor->isEditMode() || $orders)) : ?>
                <div class="elementor-field-group elementor-column elementor-col-<?= (int) $settings['reference_width'] ?> elementor-field-type-select">
                <?php if ($show_labels) : ?>
                    <label class="elementor-field-label" for="id-order-<?= $id ?>">
                        <?= $settings['reference_label'] ?: $this->trans('Order Reference') ?>
                    </label>
                <?php endif ?>
                    <div class="elementor-select-wrapper">
                        <select name="id_order" id="id-order-<?= $id ?>" class="elementor-field elementor-field-textual elementor-size-<?= esc_attr($settings['input_size']) ?>">
                            <option value=""><?= $this->trans('Select reference') ?></option>
            ...
            <?php if ($this->upload && $settings['show_upload']) : ?>
                ...
                <?php if ($show_labels) : ?>
                    <label class="elementor-field-label" for="file-upload-<?= $id ?>">
                        <?= $settings['upload_label'] ?: $this->trans('Attach File') ?>
                    </label>
                <?php endif ?>
            ...
            <?php endif ?>
                ...
                <?php if ($show_labels) : ?>
                    <label class="elementor-field-label" for="message-<?= $id ?>">
                        <?= $settings['message_label'] ?: $this->trans('Message') ?>
                    </label>
                <?php endif ?>
                ...
                <div class="elementor-field-group elementor-column elementor-col-<?= (int) $settings['button_width'] ?> elementor-field-type-submit">
                    <button type="submit" name="submitMessage" value="Send" <?= $this->getRenderAttributeString('button') ?>>
                        <span class="elementor-button-inner">
                            <span class="elementor-button-text"><?= $settings['button_text'] ?: $this->trans('Send') ?></span>
    ...
    protected function _contentTemplate()
    {
        ...
        <form class="elementor-contact-form">
            ...
            <# if (settings.show_reference) { #>
                ...
                <# if (settings.show_labels) { #>
                    <label class="elementor-field-label">{{ settings.reference_label || <?= json_encode($this->trans('Order Reference')) ?> }}</label>
                <# } #>
                    <div class="elementor-select-wrapper">
                        <select name="id_order" class="elementor-field elementor-field-textual elementor-size-{{ settings.input_size }}">
                            <option>{{ <?= json_encode($this->trans('Select reference')) ?> }}</option>
                        </select>
                    </div>
                </div>
            <# } #>
