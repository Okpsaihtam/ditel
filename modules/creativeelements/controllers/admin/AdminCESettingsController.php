        ...
        $this->fields_options['style_settings'] = [
            ...
            'fields' => [
                ...
                'elementor_page_wrapper_selector' => [
                    ...
                    'desc' => sprintf(
                        $this->l('You can force full width layout at document settings. This works for themes that have ”%s” selector. If your theme\'s selector is different, please enter it above.'),
