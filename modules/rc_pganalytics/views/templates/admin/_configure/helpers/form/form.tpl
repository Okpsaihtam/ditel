                                    ...
                                    {foreach $field as $input}
                                        {block name="input_row"}
                                                                            ...
                                                                            {literal}
                                                                                <script type="text/javascript">
                                                                                    $().ready(function () {
                                                                                        ...
                                                                                        $('#'+input_id).tagify({delimiters: [13,44], addTagPrompt: '{/literal}{l s='Add tag' js=1 mod='rc_pganalytics'}{literal}'});
                                                                ...
                                                                {literal}
                                                                    <script type="text/javascript">
                                                                        $().ready(function () {
                                                                            ...
                                                                            $('#'+input_id).tagify({delimiters: [13,44], addTagPrompt: '{/literal}{l s='Add tag' mod='rc_pganalytics'}{literal}'});
                                                                            $({/literal}'#{$table}{literal}_form').submit( function() {
                                                                                $(this).find('#'+input_id).val($('#'+input_id).tagify('serialize'));
                                                                            });
                                                                        });
                                                                        ...
                                                                        {if !isset($input.select.after) || !$input.select.after}
                                                                            <div class="input-group-btn">
                                                                                <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                                    <span class="js-inputwithselect-label">{if $name_selected}{$name_selected|escape:'html':'UTF-8'}{else}{l s='Select' mod='rc_pganalytics'}{/if}</span>
                                                                        ...
                                                                        <div class="col-lg-9">
                                                                            <div class="form-control-static row">
                                                                                <div class="col-xs-6">
                                                                                    ...
                                                                                    <a href="#" id="addSwap" class="btn btn-default btn-block">{l s='Add' mod='rc_pganalytics'} <i class="icon-arrow-right"></i></a>
                                                                                </div>
                                                                                <div class="col-xs-6">
                                                                                    ...
                                                                                    <a href="#" id="removeSwap" class="btn btn-default btn-block"><i class="icon-arrow-left"></i> {l s='Remove' mod='rc_pganalytics'}</a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                            ...
                                            {strip}
                                                ...
                                                {if $value.value == 1}
                                                    {l s='Yes' mod='rc_pganalytics'}
                                                {else}
                                                    {l s='No' mod='rc_pganalytics'}
                                                {/if}
                                            </label>
                                            {/strip}
                                            {/foreach}
                                                    ...
                                                    <span class="text-count-down">{$input.maxchar|intval}</span>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <button type="button" id="{$input.name}-btn-change" class="btn btn-default">
                                                                                <i class="icon-lock"></i>
                                                                                {l s='Change password...' mod='rc_pganalytics'}
                                                                            </button>
                                                                            <div id="{$input.name}-change-container" class="form-password-change well hide">
                                                                                <div class="form-group">
                                                                                    <label for="old_passwd" class="control-label col-lg-2 required">
                                                                                        {l s='Current password' mod='rc_pganalytics'}
                                                                                    </label>
                                                                                    <div class="col-lg-10">
                                                            ...
                                                            <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="" data-original-title="{l s='Password should be at least 8 characters long.' mod='rc_pganalytics'}">
                                                                {l s='New password' mod='rc_pganalytics'}
                                                            </span>
                                                                                    </label>
                                                                                    <div class="col-lg-9">
                                                                                        <div class="input-group fixed-width-lg">
                                                                    ...
                                                                    <i class="icon-key"></i>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <label for="{$input.name}2" class="required control-label col-lg-2">
                                                                                        {l s='Confirm password' mod='rc_pganalytics'}
                                                                                    </label>
                                                                                    <div class="col-lg-4">
                                                                                        <div class="input-group fixed-width-lg">
                                                                <span class="input-group-addon">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="col-lg-10 col-lg-offset-2">
                                                                                        ...
                                                                                        <button type="button" id="{$input.name}-generate-btn" class="btn btn-default">
                                                                                            ...
                                                                                            {l s='Generate password' mod='rc_pganalytics'}
                                                                                        </button>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="row">
                                                                    ...
                                                                    <script>
                                                                        $(function(){
                                                                            ...
                                                                            var feedback = [
                                                                                { badge: 'text-danger', text: '{l s="Invalid" js=1 mod='rc_pganalytics'}' },
                                                                                { badge: 'text-warning', text: '{l s="Okay" js=1 mod='rc_pganalytics'}' },
                                                                                { badge: 'text-success', text: '{l s="Good" js=1 mod='rc_pganalytics'}' },
                                                                                { badge: 'text-success', text: '{l s="Fabulous" js=1 mod='rc_pganalytics'}' }
                                                                            ];
                                                                            ...
                                                                            }, '{l s="Invalid password confirmation" js=1 mod='rc_pganalytics'}');
                                                                                ...
                                                                                <select name="{$key}" class="fixed-width-lg{if isset($input.class)} {$input.class}{/if}">
                                                                                    ...
                                                                                    {if $key == 'months'}
                                                                                        {*
                                                                                            ...
                                                                                            {l s='January' mod='rc_pganalytics'}
                                                                                            {l s='February' mod='rc_pganalytics'}
                                                                                            {l s='March' mod='rc_pganalytics'}
                                                                                            {l s='April' mod='rc_pganalytics'}
                                                                                            {l s='May' mod='rc_pganalytics'}
                                                                                            {l s='June' mod='rc_pganalytics'}
                                                                                            {l s='July' mod='rc_pganalytics'}
                                                                                            {l s='August' mod='rc_pganalytics'}
                                                                                            {l s='September' mod='rc_pganalytics'}
                                                                                            {l s='October' mod='rc_pganalytics'}
                                                                                            {l s='November' mod='rc_pganalytics'}
                                                                                            {l s='December' mod='rc_pganalytics'}
                                                                                        *}
                                                                                        {foreach $select as $k => $v}
                                                                                            <option value="{$k}" {if $k == $fields_value[$key]}selected="selected"{/if}>{l s=$v mod='rc_pganalytics'}</option>
                                                                                        {/foreach}
                                                                                    {else}
                                                                                        {foreach $select as $v}
                                ...
                                <div class="panel-footer">
                                    ...
                                    {if isset($show_cancel_button) && $show_cancel_button}
                                        <a href="{$back_url|escape:'html':'UTF-8'}" class="btn btn-default" {if $table}id="{$table}_form_cancel_btn"{/if} onclick="window.history.back();">
                                            <i class="process-icon-cancel"></i> {l s='Cancel' mod='rc_pganalytics'}
                                        </a>
                                    {/if}
