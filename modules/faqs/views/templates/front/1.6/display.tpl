                    ...
                    {foreach from=$mostFaq item=most}
                        {if ($most['association'] && !$most['hide_faq']) || !$most['association']}
                            ...
                            <div class="questions change_item{if $most['as_url']} as_url{/if}" >
                                ...
                                <span>{$most['question']|strip_tags|substr:0:250|escape:'htmlall'}{if strlen($most['question']) > 250} . . .{/if}</span>
                            </div>

                            {if !$most['as_url']}
                                <div class="answer_faq">
                                    {$most['answer']|escape:'htmlall'|unescape}
                                </div>
                            {/if}
                            <hr/>
                        {/if}
                                        ...
                                        {if count($faqCategory['faqs']) > 3}
                                            {if $current_question_index <= 3}
                                                <div class="questions change_item{if $question['as_url']} as_url{/if}">
                                                    ...
                                                    {$question['question']|strip_tags|substr:0:250|escape:'htmlall'}{if strlen($question['question']) > 250} . . .{/if}
                                                </div>
        ...
        <div class="gomakoil_faq_page">
            ...
            {if $faq}
                {if ($faq['association']) || !$faq['association']}
                    <section class="faq ">
                        <h1 class="title_faq_page"> {$faq['question']|escape:'htmlall':'UTF-8'|unescape} </h1>
                        <hr/>
                        <div class="answer">
                            {$faq['answer']|escape:'htmlall'|unescape}
                        </div>
                    </section>
                {/if}
            {/if}
