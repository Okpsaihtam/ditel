...
class AdminFaqsSettingsController extends ModuleAdminController
{
  ...
  public function setMedia()
  {
    ...
    $this->addJS(array(
      ...
      _PS_MODULE_DIR_ . 'faqs/views/js/faqs_admin.js',
      _PS_MODULE_DIR_ . 'faqs/views/js/faq.js',
    ));
  }

  public function displayTabSupport(){
    $tpl_path = _PS_MODULE_DIR_ . 'faqs/views/templates/front/all_versions/tabSuppor.tpl';
    $data = Context::getContext()->smarty->createTemplate($tpl_path);
    return $data->fetch();
  }

  public function displayTabModules(){
    $tpl_path = _PS_MODULE_DIR_ . 'faqs/views/templates/front/all_versions/modules.tpl';
    $data = Context::getContext()->smarty->createTemplate($tpl_path);
    return $data->fetch();
  }
